...
namespace WicramaElectricals
{
    public partial class Admin_home : Form
    {
        ...
        {
            InitializeComponent();
            slide_panel.Width = dashboard_btn.Width;
        ...
        {
            slide_panel.Width = dashboard_btn.Width;
            slide_panel.Left = dashboard_btn.Left;
            dashboard_panel.BringToFront();
        }
        //add manager button
        private void add_manager_btn_Click(object sender, EventArgs e)
        {
            slide_panel.Width = add_manager_btn.Width;
            slide_panel.Left = add_manager_btn.Left;
        ...
        {
            slide_panel.Width = user_list_btn.Width;
            slide_panel.Left = user_list_btn.Left;
            ...
            if (MfnameTxt.Text != "" && MlnameTxt.Text != "" && MusernameTxt.Text != "" && MphonenumTxt.Text != "" && MpassTxt.Text != "" && MrepassTxt.Text != "" && typecomboTxt.Text != "")
            {
                if (MpassTxt.Text == MrepassTxt.Text)
                {
                    try
                    {
                        ...
                        cmd.ExecuteNonQuery();
                        conn.Close();
                        MessageBox.Show("New Manager account is successfully created !");
                ...
                {
                    MessageBox.Show("The Passwords u entered doesn't match");
                }
            }
            else
